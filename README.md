...
The Dart sources live in `mobile/lib`. Platform runner folders (`android/`, `ios/`)
are generated by Flutter and are not committed; create them once with:

```powershell
cd mobile
flutter create .          # generates android/ ios/ runners
flutter pub get
